    ...
    <v-container class="text-justify">
        <v-row justify="center">
            <v-col cols="10" md="6">
                ...
                <p class="caption">
                    <span class="font-weight-black">Last updated:</span>
                    <span class="grey--text text--darken-2">April 20, 2020</span>
                </p>
                <p>
                    Your privacy is important to us. It is Bifrost's policy to
                    respect your privacy regarding any information we may
                    collect from you across our website,
                    <a href="https://google-drive-download.herokuapp.com">
                        https://google-drive-download.herokuapp.com
                    </a>.
                </p>
                <p>
                ...
                <p>
                    ...
                    user data and personal information, feel free to contact through
                    <a href="mailto:sarang98divakaran@gmail.com">sarang98divakaran@gmail.com</a>.
                </p>
            </v-col>
        </v-row>
    </v-container>
